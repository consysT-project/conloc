...
import de.tuda.stg.conloc.invariants.solver.subset.model.MergeMethodModel;
import de.tuda.stg.conloc.invariants.solver.subset.model.ProgramModel;
import de.tuda.stg.conloc.invariants.solver.subset.model.ReplicatedClassModel;
import de.tuda.stg.conloc.invariants.solver.subset.utils.JDTUtils;
import de.tuda.stg.conloc.invariants.solver.subset.utils.Z3SubstitutionFunction1;
...
public class MergeMethodPreconditionExpressionParser extends MethodExpressionParser {
	...
	protected Expr parseJmlMessageSend(JmlMessageSend jmlMessageSend, int depth) {
		...
		if (JDTUtils.methodMatchesSignature(jmlMessageSend.actualReceiverType, methodBinding, true, "de.tuda.stg.conloc.invariants.utils.InvariantUtils", "__merge", "java.lang.Object")) {
