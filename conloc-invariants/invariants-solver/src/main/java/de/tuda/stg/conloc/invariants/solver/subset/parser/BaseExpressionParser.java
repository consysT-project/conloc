...
import de.tuda.stg.conloc.invariants.solver.subset.utils.JDTUtils;
import de.tuda.stg.conloc.invariants.utils.InvariantUtils;
import de.tuda.stg.conloc.logging.Logger;
...
public class BaseExpressionParser extends ExpressionParser {
  ...
  protected Expr parseJmlMessageSend(JmlMessageSend jmlMessageSend, int depth) {
    ...
    //Consys Arrays
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, false, "de.tuda.stg.conloc.invariants.lib.Array", "get", "int")) {
      var receiverExpr = parseExpression(jmlMessageSend.receiver, depth + 1);
      var argExpr = parseExpression(jmlMessageSend.arguments[0], depth + 1);
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, false, "de.tuda.stg.conloc.invariants.lib.Array", "set", "int", "java.lang.Object")) {
      var receiverExpr = parseExpression(jmlMessageSend.receiver, depth + 1);
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, true, "de.tuda.stg.conloc.annotations.invariants.SetUtils", "emptySet")) {
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, true, "de.tuda.stg.conloc.annotations.invariants.SetUtils", "union", "java.util.Set", "java.util.Set")) {
      var set1Expr = parseExpression(jmlMessageSend.arguments[0], depth + 1);
      var set2Expr = parseExpression(jmlMessageSend.arguments[1], depth + 1);
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, true, "de.tuda.stg.conloc.annotations.invariants.SetUtils", "in", "java.util.Set", "java.lang.Object")) {
      var set1Expr = parseExpression(jmlMessageSend.arguments[0], depth + 1);
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, true, "de.tuda.stg.conloc.annotations.invariants.SetUtils", "add", "java.util.Set", "java.lang.Object")) {
      var set1Expr = parseExpression(jmlMessageSend.arguments[0], depth + 1);
      var elemExpr = parseExpression(jmlMessageSend.arguments[1], depth + 1);
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, true, "de.tuda.stg.conloc.annotations.invariants.ArrayUtils", "update", "int[]", "int", "int")) {
    ...
    else if (JDTUtils.methodMatchesSignature(receiverBinding, methodBinding, true, "de.tuda.stg.conloc.annotations.invariants.ArrayUtils", "update", "java.lang.Object[]", "int", "java.lang.Object")) {
      var arrExpr = parseExpression(jmlMessageSend.arguments[0], depth + 1);
      var indexExpr = parseExpression(jmlMessageSend.arguments[1], depth + 1);
      var newValExpr = parseExpression(jmlMessageSend.arguments[2], depth + 1);
