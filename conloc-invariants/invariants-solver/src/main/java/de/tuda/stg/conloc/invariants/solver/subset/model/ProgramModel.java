package de.tuda.stg.conloc.invariants.solver.subset.model;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.microsoft.z3.Context;
import com.microsoft.z3.Solver;
import de.tuda.stg.conloc.invariants.solver.EclipseCompilerBinding;
import de.tuda.stg.conloc.invariants.solver.subset.BaseClassProperties;
import de.tuda.stg.conloc.invariants.solver.subset.ClassProperties;
import de.tuda.stg.conloc.invariants.solver.subset.ProgramConfig;
import de.tuda.stg.conloc.invariants.solver.subset.ReplicatedClassProperties;
import de.tuda.stg.conloc.invariants.solver.subset.constraints.BaseClassConstraints;
import de.tuda.stg.conloc.invariants.solver.subset.constraints.ReplicatedClassConstraints;
import de.tuda.stg.conloc.invariants.solver.subset.model.types.TypeModelFactory;
...
public class ProgramModel {
	...
	public static void loadZ3Libs() {
		...
		Path libFolder = Paths.get("conloc-invariants", "invariants-solver", "lib");
		...
		for (var jmlType : declarations) {
			if (jmlType.annotations != null) {
				var hasDataModelAnnotation = Arrays.stream(jmlType.annotations)
						.anyMatch(anno -> JDTUtils.typeIsTypeOfName(anno.resolvedType, "de.tuda.stg.conloc.annotations.invariants.DataModel"));
				var hasReplicatedModelAnnotation = Arrays.stream(jmlType.annotations)
						.anyMatch(anno -> JDTUtils.typeIsTypeOfName(anno.resolvedType, "de.tuda.stg.conloc.annotations.invariants.ReplicatedModel"));
