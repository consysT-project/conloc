 ...
 * @author Mirko Köhler
 */
public class EclipseCompilerBinding {

    private EclipseCompilerBinding() { }
    ...
    public static CompileResult compile(Path[] additionalClassPath, Path[] sourceFiles) {
        ...
        classPath[0] = Paths.get("conloc-invariants", "invariants-solver", "src", "main", "resources", "rt-1.7.jar");
        classPath[1] = Paths.get("conloc-invariants", "invariants-solver", "src", "main", "resources", "scala-library-2.13.8.jar");
        classPath[2] = Paths.get("conloc-annotations", "target", "conloc-annotations-4.0.0.jar");
        classPath[3] = Paths.get("conloc-invariants", "invariants-lib", "target", "invariants-lib-4.0.0.jar");
